...
public class NavegaFilmes extends JFrame {
    ...
    public void definirEventos() {
        ...
        btPrimeiro.addActionListener(e -> navegarParaPosicao(ResultSet.FIRST)); // Navega para o primeiro registro
        btUltimo.addActionListener(e -> navegarParaPosicao(ResultSet.LAST)); // Navega para o último registro
